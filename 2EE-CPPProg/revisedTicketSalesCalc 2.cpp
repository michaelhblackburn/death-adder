...
int main()
{
	//declare variable and constants for MAIN
	...
	double finalSale			=0.0;//accumulator
	double ticketPrice			=0.0;
	double totalPrice			=0.0;
	double discountPrice		=0.0;
	double purchasePrice		=0.0;//counter
	...
	//display end sales message and prepare for final report
	report_message();
	cout <<endl;
	system("pause");
	system("cls");
...
double apply_discount(double ticketPrice)
